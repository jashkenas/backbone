...
(function(root, factory) {
  ...
  _.extend(Collection.prototype, Events, {
    ...
    create: function(model, options) {
      ...
      var collection = this;
      var success = options.success;
      options.success = function(model, resp, currentOptions) {
        if (wait) collection.add(model, currentOptions);
        if (success) success.call(currentOptions.context, model, resp, currentOptions);
      };
