...
(function(){
  ...
  _.extend(Backbone.History.prototype, {
    ...
    // Attempt to **load** (match and execute) the current URL fragment. If a
    // route succeeds with a match, returns `true`. If no defined routes matches
    ...
    // Attempt to **match** the current URL fragment. If a route succeeds with a
    // match, returns `true`. If no defined routes matches the fragment, returns
    // `false`.
    matchUrl : function(fragmentOverride) {
