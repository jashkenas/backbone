$(document).ready(function() {
  ...
  test('url, urlRoot, may be passed to the constructor', function () {
    var model = new Backbone.Model({}, {url: '/test'});
    equal(_.result(model, 'url'), '/test');
    model = new Backbone.Model({id:1}, {urlRoot:'/test'});
    equal(_.result(model, 'url'), '/test/1');
  });
