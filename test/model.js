$(document).ready(function() {
  ...
  test("Model: var args to save", function() {
    var options = {}, model = new Backbone.Model();
    model.save('foo', 1, 'bar', 2, options);
    ok(lastRequest[2] === options);
    equals(model.get('foo'), 1);
    equals(model.get('bar'), 2);
  });
