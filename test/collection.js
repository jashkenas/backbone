$(document).ready(function() {
  ...
  test("#2750 - Changes to a collection's models should change toJSON() response", 2, function() {
    ...
    ok(!col.at(0).label, "label should be removed from the collection's models");
  });
});
